...
const About = () => {
  return (
    <Container>
        <Breadcrumb/>
        <Flex className="gap-x-10 mt-[136px]">
            <div>
        ...
        <h2 className='font-dm text-[39px] font-regular text-bl my-[118px]'>Orebi is one of the world’s leading ecommerce brands and is internationally recognized for celebrating the essence of classic Worldwide cool looking style.</h2>
